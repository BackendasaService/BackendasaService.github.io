        ...
        <div class="row">
            <nav>
                <div class="resource-group">
                    <div class="heading">
                        <div class="chevron"><i class="open fa fa-angle-down"></i></div><a href="#top">Overview</a>
                    </div>
                    <div class="collapse-content">
                        <ul>
                            <li><a href="#header-getting-started">Getting Started</a></li>
                        </ul>
                    </div>
                </div>
                <div class="resource-group">
                    <div class="heading">
                        <div class="chevron"><i class="open fa fa-angle-down"></i></div><a href="#Documentation">Documentation</a>
                    </div>
                    <div class="collapse-content">
                        <ul>
                            <li><a href="#user_create"></span>user.create</a></li>
<li><a href="#user_login"></span>user.login</a></li>
                        </ul>
                    </div>
                </div>
                <p style="text-align: center; word-wrap: break-word;"><a href="http://sitename.ext/BaaS/index.php">http://sitename.ext/BaaS/index.php</a></p>
            </nav>
            <div class="content">
                <div id="right-panel-background"></div>
                <div class="middle">
                    <header><h1 id="top">BaaS API Documentation</h1>
                    </header>
                </div>
                <div class="right"><h5>API Endpoint</h5><a href="http://sitename.ext/BaaS/index.php">http://sitename.ext/BaaS/index.php</a></div>
                <div class="middle">
                    <p>This is the official documentation for communication with the BaaS Backend Server.</p>
                    <p>API Version: <code>1.0</code></p>
                    <p>&nbsp;</p>
                    <h2 id="header-getting-started">Getting Started <a class="permalink" href="#header-getting-started" aria-hidden="true">¶</a></h2>
                    <p>All requests must be made with POST and with a body which starts with <code>JSON=</code></p>
                </div>
                
                <hr class="split">
                <div class="middle">
                    <div id="" class="resource"><h3 class="resource-heading">Create a user <a href="#" class="permalink">&para;</a></h3>
                    </div>
                </div>
                <div class="right">
                    <div class="definition"><span class="method post">POST</span>&nbsp;<span class="uri"><span class="hostname">http://sitename.ext/BaaS/index.php</span>/user.create</span></div>
                    <div class="tabs">
                        <!--
                        <div class="example-names"><span>Requests</span><span class="tab-button">example 1</span></div>
                    -->
                        <div class="tab">
                            <div>
                                <div class="inner">
                                    <div style="height: 1px;"></div>
                                    <h5>Body</h5><pre><code>JSON=</font><font color='white'>{</font>
    <font color='#02bcf4'>"APIKey"</font><font color='white'>:</font><font color='green'>"YOUR_API_KEY"</font><font color='white'>,</font>
    <font color='#02bcf4'>"username"</font><font color='white'>:</font><font color='green'>"THE_USERNAME"</font><font color='white'>,</font>
    <font color='#02bcf4'>"password"</font><font color='white'>:</font><font color='green'>"THE_PASSWORD"</font><font color='white'>,</font>
    <font color='#02bcf4'>"email"</font><font color='white'>:</font><font color='green'>"THE_EMAIL"</font><font color='white'>,</font>
                            ...
                            <div class="tabs">
                                <div class="example-names">
                                    <span>Responses</span>
                                    <span class="tab-button">200</span>
<span class="tab-button">300</span>
<span class="tab-button">400</span>
                                </div>
                                
                                <div class="tab">
                                    <div>
                                        <div class="inner">
                                            <div class="description"><pre><code>200</code></pre>
                                            </div>
                                            <div style="height: 1px;"></div>
                                        </div>
                                    </div>
                                ...
                                <div class="tab">
                                    <div>
                                        <div class="inner">
                                            <div class="description"><pre><code>300</code></pre>
                                            </div>
                                            <div style="height: 1px;"></div>
                                        </div>
                                    </div>
                                ...
                                <div class="tab">
                                    <div>
                                        <div class="inner">
                                            <div class="description"><pre><code>400</code></pre>
                                            </div>
                                            <div style="height: 1px;"></div>
                                        </div>
                                    </div>
                ...
                <div class="middle">
                    <div id="" class="action post"><h4 class="action-heading"><div class="name">Create a user</div><a href="#" class="method post">POST</a><code class="uri">/user.create</code></h4>
                        <p>With this call you can create a user.</p>
                    </div>
                </div>
                ...
                <hr class="split">
                <div class="middle">
                    <div id="" class="resource"><h3 class="resource-heading">Login a user <a href="#" class="permalink">&para;</a></h3>
                    </div>
                </div>
                <div class="right">
                    <div class="definition"><span class="method post">POST</span>&nbsp;<span class="uri"><span class="hostname">http://sitename.ext/BaaS/index.php</span>/user.login</span></div>
                    <div class="tabs">
                        <!--
                        <div class="example-names"><span>Requests</span><span class="tab-button">example 1</span></div>
                    -->
                        <div class="tab">
                            <div>
                                <div class="inner">
                                    ...
                                    <h5>Body</h5><pre><code>JSON=</font><font color='white'>{</font>
    <font color='#02bcf4'>"APIKey"</font><font color='white'>:</font><font color='green'>"YOUR_API_KEY"</font><font color='white'>,</font>
    <font color='#02bcf4'>"password"</font><font color='white'>:</font><font color='green'>""</font><font color='white'>,</font>
</font><font color='white'>}</font>
</code></pre>
                                    <div style="height: 1px;"></div>
                                </div>
...
<span class="tab-button">400</span>
                ...
                <div class="middle">
                    <div id="" class="action post"><h4 class="action-heading"><div class="name">Login a user</div><a href="#" class="method post">POST</a><code class="uri">/user.login</code></h4>
                        <p>With this call you can login a user.</p>
                    </div>
                </div>
                
                <hr class="split">
                <div class="middle">
                    <p style="text-align: center;" class="text-muted">Last update Mon 07 Jan 2019
                    </p>
                </div>
            </div>
        </div>
